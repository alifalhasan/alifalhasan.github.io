...
# name_pronunciation: Alif Al Hasan
...
social:
  ...
  - icon: graduation-cap # Alternatively, use `google-scholar` icon from `ai` icon pack
    icon_pack: fas
    link: https://scholar.google.com/citations?user=yu0t6qsAAAAJ&hl=en
  - icon: github
    icon_pack: fab
    link: https://github.com/alifalhasan
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/alif-al-hasan/
